...
func (i *LayerShell) GetLayerSurface(surface *client.Surface, output *client.Output, layer uint32, namespace string) (*LayerSurface, error) {
	...
	client.PutUint32(r[l:l+4], uint32(layer))
	l += 4
	client.PutString(r[l:l+(4+namespaceLen)], namespace, namespaceLen)
	l += (4 + namespaceLen)
...
type LayerSurface struct {
	client.BaseProxy
	configureHandlers []LayerSurfaceConfigureHandlerFunc
	closedHandlers    []LayerSurfaceClosedHandlerFunc
}
...
func (i *LayerSurface) SetExclusiveZone(zone int32) error {
	...
	client.PutUint32(r[l:l+4], uint32(rLen<<16|opcode&0x0000ffff))
	l += 4
	client.PutUint32(r[l:l+4], uint32(zone))
	l += 4
	err := i.Context().WriteMsg(r, nil)
	return err
}
...
func (i *LayerSurface) SetMargin(top, right, bottom, left int32) error {
	...
	client.PutUint32(r[l:l+4], uint32(rLen<<16|opcode&0x0000ffff))
	l += 4
	client.PutUint32(r[l:l+4], uint32(top))
	l += 4
	client.PutUint32(r[l:l+4], uint32(right))
	l += 4
	client.PutUint32(r[l:l+4], uint32(bottom))
	l += 4
	client.PutUint32(r[l:l+4], uint32(left))
	l += 4
	err := i.Context().WriteMsg(r, nil)
	return err
}
...
func (i *LayerSurface) SetKeyboardInteractivity(keyboardInteractivity uint32) error {
	...
	client.PutUint32(r[l:l+4], uint32(rLen<<16|opcode&0x0000ffff))
	l += 4
	client.PutUint32(r[l:l+4], uint32(keyboardInteractivity))
	l += 4
	err := i.Context().WriteMsg(r, nil)
	return err
}
...
func (i *LayerSurface) GetPopup(popup *xdg_shell.Popup) error {
	...
	client.PutUint32(r[l:l+4], uint32(rLen<<16|opcode&0x0000ffff))
	l += 4
	client.PutUint32(r[l:l+4], popup.ID())
	l += 4
	err := i.Context().WriteMsg(r, nil)
	return err
}
...
// AddConfigureHandler : adds handler for LayerSurfaceConfigureEvent
func (i *LayerSurface) AddConfigureHandler(f LayerSurfaceConfigureHandlerFunc) {
	if f == nil {
		return
	}
...
// AddClosedHandler : adds handler for LayerSurfaceClosedEvent
func (i *LayerSurface) AddClosedHandler(f LayerSurfaceClosedHandlerFunc) {
	if f == nil {
		return
	}

	i.closedHandlers = append(i.closedHandlers, f)
}

func (i *LayerSurface) Dispatch(opcode uint16, fd uintptr, data []byte) {
	switch opcode {
	case 0:
	...
	case 1:
		if len(i.closedHandlers) == 0 {
			return
		}
		var e LayerSurfaceClosedEvent
		for _, f := range i.closedHandlers {
			f(e)
		}
	}
}
